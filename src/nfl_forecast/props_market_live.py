...
NFL_TEAM_ALIASES = {
    ...
    # PropLine discovery currently renders most NFL teams as
    # "{book abbreviation} {nickname}". Keep these exact aliases explicit so
    # ambiguous LA/NY labels never rely on heuristic prefix parsing.
    "aricardinals": "ARI",
    "atlfalcons": "ATL",
    "balravens": "BAL",
    "bufbills": "BUF",
