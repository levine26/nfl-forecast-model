...
def _snapshot_rank1_depth_charts(
    ...
    *,
    ...
    """Freeze the latest qualified pregame rank-1 depth-chart rows by team.

    Source snapshot time and local capture time are distinct. Naive, future,
    unidentifiable, and non-rank-1 rows fail closed. The snapshot is categorical
    personnel evidence only; it does not carry a workload multiplier.
    """
