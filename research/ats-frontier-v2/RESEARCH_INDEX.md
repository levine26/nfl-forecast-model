...
This directory is the canonical record for `LEVLINE_ATS_FRONTIER_V2`.

## Program control
- `MASTER_PLAN.md` — governing question, survivor mechanisms, seven-phase roadmap and firewalls.
- `PHASE_STATUS.md` — authoritative phase state.
- `CURRENT_STATE_AND_NEXT_STEPS.md` — handoff and next executable action.
- `DECISION_LOG.md` — irreversible scientific/governance decisions across phases.
- `phase1_registry.json` — machine-readable Phase-1 contract.
- `candidate_registry.json` — candidate identities and current evidence/classification state.
- `EVIDENCE_BOUNDARY.md` — chronology/PIT/outcome boundary.
- `PRODUCTION_FIREWALL.md` — protected production surfaces.
...
- `phase4_evidence/ATS_DIAGNOSTICS.json`
- `phase4_evidence/RED_TEAM_AUDIT.md`
- `phase4_evidence/PHASE4_EVIDENCE_SYNTHESIS.md` / `.json`
- `phase4_evidence/PHASE5_HANDOFF.md`

## Current scientific boundary

Phase 4 has accepted empirical development evidence for M3 and M4, but repository merge/closeout is not yet complete and Phase 5 is `NOT_STARTED`. Phase-4 evidence labels are not survivor classifications. Production remains `F-ST-01-FROZEN-2026` and unchanged; completed-2026 outcomes remain excluded.
