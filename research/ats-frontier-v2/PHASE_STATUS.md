...
| Phase 4 — Controlled historical development, ablation & empirical validation | `EVIDENCE_COMPLETE__PENDING_REPOSITORY_MERGE` | Accepted chronology-clean M3/M4 evidence package exists; primary PR/merge and immutable post-merge receipt remain. |
...
Canonical accepted execution: workflow run `36025306390`, artifact `10820230932`.
...
The earlier workflow run `36023376614` is explicitly superseded and unaccepted; its metrics are not part of the scientific record.
