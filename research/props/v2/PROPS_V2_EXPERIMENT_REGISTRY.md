...
| P2-SHADOW-MKT-V1-V01 | Frozen global residual improves market-only probability prospectively | Prospective untouched | ACTIVE — #379/#407/#418 merged; 545 legacy receipts preserved; source run 35457112800 generated 465 eligible rows but post-capture legacy enforcement failed before persistence; #431 merged repair | Persisted provenance-eligible receipts remain 0; failed source is not replayed/backfilled; frozen coefficients only |
| P2-SHADOW-A-DEFENSE | Frozen rushing + receiving opponent-defense residuals improve untouched future pregame distributions vs V1 | Prospective shadow | ACTIVE — #402/#418 merged; 289 legacy receipts preserved; source run 35457112800 generated 245 eligible rows but post-capture legacy enforcement failed before persistence; #431 merged repair | Persisted provenance-eligible Shadow A receipts remain 0; failed source is not replayed/backfilled |
| P2-SHADOW-A-GRADER | Grade immutable Shadow A receipts with frozen proper-score and uncertainty policy | Prospective grading | ACTIVE / FROZEN — #406/#418 merged; zero provenance-eligible receipts persisted and zero eligible outcomes graded | Legacy rows are hash/chronology audited then excluded before outcome lookup; 300 decided / 100 games / 8 weeks remain discussion thresholds only |
| P2-SHADOW-B-DEFENSE-ROLE | Shadow A plus Dynamic Role V0.1 full improves untouched future distributions vs V1 | Prospective shadow | ACTIVE / REPLAY REPAIR — #405/#411/#418 merged; run 35457112800 exposed exact-replay bug from dropping zero-availability eligible players before V1 concentration scaling; zero receipts persisted; #429 metadata + #432 replay repairs merged | #432 restores canonical full-eligible-roster algebra without widening tolerance; #429 retains applied V1 multipliers for future exact replay; failed source is not replayed/backfilled |
| P2-SHADOW-B-GRADER | Score immutable Shadow B receipts primarily vs matched Shadow A and secondarily vs V1 | Prospective grading | ACTIVE / FROZEN — #409/#418 merged before first eligible B receipt/outcome; zero eligible B receipts | Only integrity-matched provenance-eligible A/B receipts enter B-vs-A thresholds; fixed scoring/bootstrap policy; never automatic promotion |
| P2-MICRO-V2 | Player-prop multi-book state / movement adds value vs one OPEN quote | Prospective + historical where licensed | ACTIVE — #381/#413/#418 merged; 4 legacy snapshots / 3,700 rows excluded; source run 35457112800 persisted first provenance-eligible 892-row snapshot | Continue untouched timestamped capture; no outcome-tuned horizon selection |
...
| P2-CLV-V1 | LevLine disagreement predicts subsequent market movement | Prospective | CAPTURE ACTIVE — 892 provenance-eligible archive rows from run 35457112800; 3,700 legacy rows excluded; horizon selector reports 892 identities / 1,724 selected horizon rows | Frozen horizon/close policy; do not grade movement/CLV until sufficient repeated timestamp-qualified captures accumulate |
