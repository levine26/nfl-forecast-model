...
| P2-SHADOW-A-DEFENSE | Frozen rushing + receiving opponent-defense residuals improve untouched future pregame distributions vs V1 | Prospective shadow | PR #402 — immutable capture listener in validation | Primary prospective football challenger; exact V1 manifest replay; exact #394 mechanism/RNG identity; no outcomes read; evidence persists off main |
...
| P2-SHADOW-B-DEFENSE-ROLE | Shadow A plus Dynamic Role V0.1 full improves untouched future distributions vs V1 | Prospective shadow | NOT IMPLEMENTED / ZERO RECEIPTS | Secondary candidate only; no outcome before its first immutable receipt may enter its prospective sample |
