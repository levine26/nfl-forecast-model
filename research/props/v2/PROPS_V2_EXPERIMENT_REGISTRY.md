...
| P2-SHADOW-B-DEFENSE-ROLE | Shadow A plus Dynamic Role V0.1 full improves untouched future distributions vs V1 | Prospective shadow | ACTIVE / REPLAY REPAIR — #405/#411/#418 merged; run 35457112800 exposed exact-replay bug from dropping zero-availability eligible players before V1 concentration scaling; zero receipts persisted; #430 pending | #430 restores canonical full-eligible-roster algebra without widening tolerance or changing Dynamic Role V0.1; failed source is not replayed/backfilled |
