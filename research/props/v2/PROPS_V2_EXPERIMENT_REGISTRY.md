...
| P2-SHADOW-MKT-V1-V01 | Frozen global residual improves market-only probability prospectively | Prospective untouched | ACTIVE LISTENER — PR #379 merged to main; awaiting first post-merge qualifying receipt | Frozen coefficients only; no 2026 fitting or post-kickoff reconstruction |
| P2-SHADOW-A-DEFENSE | Frozen rushing + receiving opponent-defense residuals improve untouched future pregame distributions vs V1 | Prospective shadow | ACTIVE — PR #402 merged to main; zero receipts until next qualifying post-merge live refresh | Primary prospective football challenger; exact V1 manifest replay; exact #394 mechanism/RNG identity; no outcomes read; evidence persists off main |
| P2-SHADOW-A-GRADER | Grade immutable Shadow A receipts with frozen proper-score and uncertainty policy | Prospective grading | ACTIVE / FROZEN — PR #406 merged to main before first eligible receipt/outcome | Report-only; 300 decided / 100 games / 8 weeks are discussion thresholds, never automatic promotion |
| P2-SHADOW-B-DEFENSE-ROLE | Shadow A plus Dynamic Role V0.1 full improves untouched future distributions vs V1 | Prospective shadow | ACTIVE LISTENER — PR #405 merged to main; zero receipts until first qualifying post-merge live refresh | Secondary candidate only; no outcome before its first immutable receipt may enter its prospective sample |
| P2-SHADOW-B-GRADER | Score immutable Shadow B receipts primarily vs matched Shadow A and secondarily vs V1 | Prospective grading | PR #409 — frozen before first B receipt/outcome | Only integrity-matched A/B receipts enter B-vs-A thresholds; fixed scoring/bootstrap policy; never automatic promotion |
