...
| P2-SHADOW-A-GRADER | Grade immutable Shadow A receipts with frozen proper-score and uncertainty policy | Prospective grading | PR #406 — frozen before first grade; depends on #402 receipt schema | Report-only; 300 decided / 100 games / 8 weeks are discussion thresholds, never automatic promotion |
| P2-SHADOW-B-DEFENSE-ROLE | Shadow A plus Dynamic Role V0.1 full improves untouched future distributions vs V1 | Prospective shadow | PR #405 — exact V0.1 + defense listener implemented, rebased to main, in validation; zero receipts | Secondary candidate only; no outcome before its first immutable receipt may enter its prospective sample |
